#!/usr/bin/env python3
"""
Recuperation des codes promo Spreadshirt depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/spreadshirt.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/spreadshirt.fr"
STORE_NAME = "Spreadshirt"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Spreadshirt depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-spreadshirt)"
    }
    try:
